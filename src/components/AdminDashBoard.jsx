  ...
  return (
    <div className={darkMode ? 'min-h-screen bg-gray-900 text-white' : 'min-h-screen bg-gray-100 text-black'}>
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside
          className={`${isSidebarOpen ? 'block' : 'hidden'} md:block w-64 h-screen bg-white dark:bg-gray-800 shadow-lg p-4 fixed md:static z-10 text-white`}
        >
          <div className="mb-8 text-center">
            ...
            <span className="mt-2 inline-block text-xs text-blue-600 bg-blue-100 px-2 py-1 rounded">Admin</span>
          </div>
